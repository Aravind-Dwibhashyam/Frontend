...
@st.cache_resource
def get_db():
    client = MongoClient(st.secrets.get("MONGO_URI", "mongodb://localhost:27017/"))
...
with st.sidebar:
    ...
    st.markdown("---")
    st.markdown("<small style='color:#4a7a94'>Schema: ER v1.0<br>DB: MongoDB</small>", unsafe_allow_html=True)
